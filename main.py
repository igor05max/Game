...
while running:
    ...
    walls = vision_new(player.x, player.y, player.angle, textures)
    ...
    ball(screen, hall)
    true = False
    if transition(player.x, player.y) and number() >= number_sprite:
